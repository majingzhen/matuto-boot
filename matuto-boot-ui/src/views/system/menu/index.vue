<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="menuList" row-key="menuId" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" v-if="refreshTable">
        ...
        <el-row>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="isFrame">
              <span slot="label">
                <el-tooltip content="选择是则路由地址显示为http(s)://开头" placement="top">
                  <i class="el-icon-question"></i>
                </el-tooltip>
                是否外链
              </span>
  ...
  methods: {
    ...
    getTreeselect() {
      listMenu().then(response => {
        ...
        menu.children = this.handleTree(response.data, "menuId", "parentId");
